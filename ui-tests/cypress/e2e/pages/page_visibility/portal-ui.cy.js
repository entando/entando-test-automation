      ...
      TEST_GROUPS.forEach(ownerGroup => {
        ...
        describe(`Page with ${ownerGroup} owner group`, () => {
          ...
          if (ownerGroup === groupPermission) {
            ...
            it([Tag.SANITY, 'ENG-3798'], `A user with "${groupPermission}" permission SHOULD${visibility}be able to view a page with "${ownerGroup}" owner group and no join group`, () => checkPermission(permission));
          }
